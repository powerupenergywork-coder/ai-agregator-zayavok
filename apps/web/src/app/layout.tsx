...
export const metadata: Metadata = {
  ...
  //
  // «В Астане» из заголовка ушло вместе с выходом в другие города: жителю
  // Караганды такая выдача говорила «не про вас». Городские запросы
  // («манипулятор астана») теперь ловят посадочные /u/<услуга>/<город>.
  title: "Спецтехника, грузчики и мастера по Казахстану — KerekTap",
  description:
    "Опишите задачу своими словами — исполнители из вашего города перезвонят напрямую. " +
    "Манипулятор, автокран, самосвал, газель, грузчики, электрик, сантехник, уборка.",
  openGraph: {
    title: "Спецтехника, грузчики и мастера — KerekTap",
    description: "Опишите задачу своими словами, исполнители из вашего города перезвонят вам напрямую.",
    url: SITE_URL,
    type: "website",
  },
};
