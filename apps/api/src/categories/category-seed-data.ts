...
export const CATEGORY_SEED_DATA: CategoryTemplate[] = [
  ...
  // Четыре бытовые услуги, добавлены 4 сентября. Первые не про спецтехнику:
  // спрос на электрика и сантехника ровный круглый год, а сезонность крана и
  // самосвала мы уже видели. Полей по-прежнему мало — вопрос, ответа на
  // который человек не знает, стоит заявки (ops/trim-category-fields.sql).
  {
    slug: "electrician",
    name: { ru: "Электрик", kk: "Электрик" },
    icon: "bolt",
    examples: [
      { ru: "Нужен электрик поменять розетки", kk: "Розеткаларды ауыстыруға электрик керек" },
      { ru: "Не работает свет в квартире", kk: "Пәтерде жарық жоқ" },
    ],
    fields: [
      {
        key: "city",
      ...
      {
        key: "taskType",
        label: { ru: "Что нужно сделать", kk: "Не істеу керек" },
        type: "enum",
        required: false,
        options: [
          { value: "sockets", label: { ru: "Розетки, выключатели", kk: "Розеткалар, ажыратқыштар" } },
          { value: "wiring", label: { ru: "Проводка", kk: "Сым тарту" } },
          { value: "panel", label: { ru: "Щиток, автоматы", kk: "Қалқан, автоматтар" } },
          { value: "light", label: { ru: "Свет, люстра", kk: "Жарық, люстра" } },
          { value: "other", label: { ru: "Другое", kk: "Басқа" } },
        ],
        question: {
          ru: "Что нужно — розетки, проводка, щиток, свет?",
          kk: "Не керек — розеткалар, сым тарту, қалқан, жарық па?",
        },
      },
      {
        key: "date",
        ...
        type: "date",
        required: true,
        question: { ru: "На какую дату нужен электрик?", kk: "Электрик қай күнге керек?" },
      },
      {
        key: "address",
        label: { ru: "Адрес", kk: "Мекенжай" },
      ...
      },
      {
        ...
        required: false,
        question: {
          ru: "Прикрепите фото, если есть — по нему часто видно объём работы.",
          kk: "Мүмкіндігінше фото тіркеңіз — жұмыс көлемі көбіне содан көрінеді.",
        },
      },
    ],
  },
  {
    slug: "plumber",
    name: { ru: "Сантехник", kk: "Сантехник" },
    icon: "pipe",
    examples: [
      { ru: "Нужен сантехник, течёт кран", kk: "Сантехник керек, кран ағып тұр" },
      { ru: "Засор в трубе на кухне", kk: "Ас үйде құбыр бітеліп қалды" },
    ],
    fields: [
      {
        key: "city",
      ...
      },
      {
        ...
        required: false,
        options: [
          { value: "leak", label: { ru: "Течь, протечка", kk: "Ағу, су ағуы" } },
          { value: "clog", label: { ru: "Засор", kk: "Бітелу" } },
          { value: "install", label: { ru: "Установка сантехники", kk: "Сантехника орнату" } },
          { value: "pipes", label: { ru: "Замена труб", kk: "Құбыр ауыстыру" } },
          { value: "other", label: { ru: "Другое", kk: "Басқа" } },
        ],
        question: {
          ru: "Что случилось — течь, засор, установка, замена труб?",
          kk: "Не болды — ағу, бітелу, орнату, құбыр ауыстыру ма?",
        },
      },
      {
        key: "date",
        ...
        type: "date",
        required: true,
        question: { ru: "На какую дату нужен сантехник?", kk: "Сантехник қай күнге керек?" },
      },
      {
        key: "address",
        label: { ru: "Адрес", kk: "Мекенжай" },
      ...
      },
      {
        ...
        required: false,
        question: {
          ru: "Прикрепите фото, если есть — так мастер сразу возьмёт нужные детали.",
          kk: "Мүмкіндігінше фото тіркеңіз — шебер керек бөлшектерді бірден алады.",
        },
      },
    ],
  },
  {
    slug: "cleaning",
    name: { ru: "Уборка, клининг", kk: "Тазалау, клининг" },
    icon: "broom",
    examples: [
      { ru: "Нужна уборка квартиры после ремонта", kk: "Жөндеуден кейін пәтерді тазалау керек" },
      { ru: "Помыть окна в офисе", kk: "Кеңседе терезе жуу керек" },
    ],
    fields: [
      {
        key: "city",
      ...
      {
        key: "objectType",
        label: { ru: "Что убираем", kk: "Нені тазалаймыз" },
        type: "enum",
        required: false,
        options: [
          { value: "flat", label: { ru: "Квартира", kk: "Пәтер" } },
          { value: "house", label: { ru: "Дом", kk: "Үй" } },
          { value: "office", label: { ru: "Офис", kk: "Кеңсе" } },
          { value: "after_repair", label: { ru: "После ремонта", kk: "Жөндеуден кейін" } },
          { value: "windows", label: { ru: "Только окна", kk: "Тек терезелер" } },
        ],
        question: {
          ru: "Что убираем — квартиру, дом, офис, после ремонта?",
          kk: "Нені тазалаймыз — пәтер, үй, кеңсе, жөндеуден кейін бе?",
        },
      },
      {
        // Площадь человек про своё жильё знает наизусть — в отличие от
        // объёма мусора, который мы спрашивать перестали.
        key: "area",
        label: { ru: "Площадь", kk: "Ауданы" },
        type: "number",
        required: false,
      ...
      },
      {
        ...
        type: "date",
        required: true,
        question: { ru: "На какую дату нужна уборка?", kk: "Тазалау қай күнге керек?" },
      },
      {
        key: "address",
        label: { ru: "Адрес", kk: "Мекенжай" },
  ...
  {
    slug: "tow-truck",
    name: { ru: "Эвакуатор", kk: "Эвакуатор" },
    icon: "tow",
    examples: [
      { ru: "Нужен эвакуатор, машина не заводится", kk: "Эвакуатор керек, көлік от алмай тұр" },
      { ru: "Отвезти машину в сервис", kk: "Көлікті сервиске жеткізу керек" },
    ],
    fields: [
      {
        key: "city",
      ...
      {
        key: "carType",
        label: { ru: "Что везём", kk: "Нені тасымалдаймыз" },
        type: "enum",
        required: false,
        options: [
          { value: "sedan", label: { ru: "Легковая", kk: "Жеңіл көлік" } },
          { value: "suv", label: { ru: "Кроссовер, внедорожник", kk: "Кроссовер, жол талғамайтын" } },
          { value: "van", label: { ru: "Микроавтобус, газель", kk: "Шағын автобус, газель" } },
          { value: "truck", label: { ru: "Грузовая", kk: "Жүк көлігі" } },
          { value: "moto", label: { ru: "Мотоцикл", kk: "Мотоцикл" } },
        ],
        question: {
          ru: "Что за машина — легковая, кроссовер, грузовая?",
          kk: "Қандай көлік — жеңіл, кроссовер, жүк көлігі ме?",
        },
      },
      {
        // Два адреса одним вопросом: у эвакуатора «откуда» без «куда»
        // бесполезно, а два вопроса подряд про адрес человек не дожидается.
        key: "addressFrom",
        label: { ru: "Откуда забрать", kk: "Қайдан алу керек" },
        type: "address",
        required: false,
        question: {
          ru: "Откуда забрать машину и куда отвезти?",
          kk: "Көлікті қайдан алып, қайда жеткізу керек?",
        },
        combineGroup: "addresses",
      },
      {
        key: "addressTo",
        label: { ru: "Куда отвезти", kk: "Қайда жеткізу керек" },
        type: "address",
        required: false,
        question: {
          ru: "Откуда забрать машину и куда отвезти?",
      ...
      },
      {
        ...
        type: "date",
        required: true,
        question: { ru: "На какую дату нужен эвакуатор?", kk: "Эвакуатор қай күнге керек?" },
      },
      {
        key: "photos",
        label: { ru: "Фотографии", kk: "Фотосуреттер" },
        ...
        required: false,
        question: {
          ru: "Прикрепите фото машины и места, если есть.",
          kk: "Мүмкіндігінше көлік пен тұрған жердің фотосын тіркеңіз.",
        },
      },
    ],
  },
